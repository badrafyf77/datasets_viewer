...
const els = {
  ...
  navHfHub: document.getElementById("navHfHub"),
  ...
  hfHubPage: document.getElementById("hfHubPage"),
  ...
  hfImportTrustRemoteCodeInput: document.getElementById(
    "hfImportTrustRemoteCodeInput",
  ),
  ...
  generatorTargetHoursInput: document.getElementById(
    "generatorTargetHoursInput",
  ),
  ...
  generatorReferenceDirInput: document.getElementById(
    "generatorReferenceDirInput",
  ),
  ...
  generationProgressPercent: document.getElementById(
    "generationProgressPercent",
  ),
  generationProgressFill: document.getElementById("generationProgressFill"),
  generationProgressDetails: document.getElementById(
  ...
  cleanerTranscriptColumnInput: document.getElementById(
  ...
  cleanerOverwriteOutputField: document.getElementById(
    "cleanerOverwriteOutputField",
  ),
  cleanerOverwriteOutputInput: document.getElementById(
    "cleanerOverwriteOutputInput",
  ),
  ...
  textNormalizerDatasetPathInput: document.getElementById(
    "textNormalizerDatasetPathInput",
  ),
  textNormalizerTranscriptColumnInput: document.getElementById(
    "textNormalizerTranscriptColumnInput",
  ),
  textNormalizerOutputColumnInput: document.getElementById(
    "textNormalizerOutputColumnInput",
  ),
  textNormalizerLanguageColumnInput: document.getElementById(
    "textNormalizerLanguageColumnInput",
  ),
  textNormalizerLanguageInput: document.getElementById(
    "textNormalizerLanguageInput",
  ),
  textNormalizerTaMarbutaInput: document.getElementById(
    "textNormalizerTaMarbutaInput",
  ),
  textNormalizerStripAccentsInput: document.getElementById(
    "textNormalizerStripAccentsInput",
  ),
  textNormalizerOverwriteTextInput: document.getElementById(
    "textNormalizerOverwriteTextInput",
  ),
  textNormalizerSaveModeInput: document.getElementById(
    "textNormalizerSaveModeInput",
  ),
  textNormalizerOutputPathField: document.getElementById(
    "textNormalizerOutputPathField",
  ),
  textNormalizerOutputPathInput: document.getElementById(
    "textNormalizerOutputPathInput",
  ),
  textNormalizerOverwriteOutputField: document.getElementById(
    "textNormalizerOverwriteOutputField",
  ),
  textNormalizerOverwriteOutputInput: document.getElementById(
    "textNormalizerOverwriteOutputInput",
  ),
  runTextNormalizerButton: document.getElementById("runTextNormalizerButton"),
  textNormalizerProgressCard: document.getElementById(
    "textNormalizerProgressCard",
  ),
  textNormalizerProgressLabel: document.getElementById(
    "textNormalizerProgressLabel",
  ),
  textNormalizerProgressPercent: document.getElementById(
    "textNormalizerProgressPercent",
  ),
  textNormalizerProgressFill: document.getElementById(
    "textNormalizerProgressFill",
  ),
  textNormalizerProgressDetails: document.getElementById(
    "textNormalizerProgressDetails",
  ),
  ...
  durationFilterDatasetPathInput: document.getElementById(
    "durationFilterDatasetPathInput",
  ),
  durationFilterDurationColumnInput: document.getElementById(
    "durationFilterDurationColumnInput",
  ),
  durationFilterAudioColumnInput: document.getElementById(
    "durationFilterAudioColumnInput",
  ),
  durationFilterMinSecondsInput: document.getElementById(
    "durationFilterMinSecondsInput",
  ),
  durationFilterMaxSecondsInput: document.getElementById(
    "durationFilterMaxSecondsInput",
  ),
  durationFilterSaveModeInput: document.getElementById(
    "durationFilterSaveModeInput",
  ),
  durationFilterOutputPathField: document.getElementById(
    "durationFilterOutputPathField",
  ),
  durationFilterOutputPathInput: document.getElementById(
    "durationFilterOutputPathInput",
  ),
  durationFilterOverwriteOutputField: document.getElementById(
    "durationFilterOverwriteOutputField",
  ),
  durationFilterOverwriteOutputInput: document.getElementById(
    "durationFilterOverwriteOutputInput",
  ),
  runDurationFilterButton: document.getElementById("runDurationFilterButton"),
  durationFilterProgressCard: document.getElementById(
    "durationFilterProgressCard",
  ),
  durationFilterProgressLabel: document.getElementById(
    "durationFilterProgressLabel",
  ),
  durationFilterProgressPercent: document.getElementById(
    "durationFilterProgressPercent",
  ),
  durationFilterProgressFill: document.getElementById(
    "durationFilterProgressFill",
  ),
  durationFilterProgressDetails: document.getElementById(
    "durationFilterProgressDetails",
  ),
  ...
  augmentationDatasetPathInput: document.getElementById(
    "augmentationDatasetPathInput",
  ),
  augmentationAudioColumnInput: document.getElementById(
    "augmentationAudioColumnInput",
  ),
  augmentationDurationColumnInput: document.getElementById(
    "augmentationDurationColumnInput",
  ),
  augmentationSplitInput: document.getElementById("augmentationSplitInput"),
  augmentationTargetPercentInput: document.getElementById(
    "augmentationTargetPercentInput",
  ),
  augmentationSourceColumnInput: document.getElementById(
    "augmentationSourceColumnInput",
  ),
  augmentationIncludeSourcesInput: document.getElementById(
    "augmentationIncludeSourcesInput",
  ),
  augmentationExcludeSourcesInput: document.getElementById(
    "augmentationExcludeSourcesInput",
  ),
  augmentationSpeedCoverageInput: document.getElementById(
    "augmentationSpeedCoverageInput",
  ),
  augmentationNoiseCoverageInput: document.getElementById(
    "augmentationNoiseCoverageInput",
  ),
  augmentationReverbCoverageInput: document.getElementById(
    "augmentationReverbCoverageInput",
  ),
  augmentationTelephonyCoverageInput: document.getElementById(
    "augmentationTelephonyCoverageInput",
  ),
  augmentationGainCoverageInput: document.getElementById(
    "augmentationGainCoverageInput",
  ),
  augmentationMaxCopiesInput: document.getElementById(
    "augmentationMaxCopiesInput",
  ),
  augmentationSeedInput: document.getElementById("augmentationSeedInput"),
  augmentationSaveModeInput: document.getElementById(
    "augmentationSaveModeInput",
  ),
  augmentationOutputPathField: document.getElementById(
    "augmentationOutputPathField",
  ),
  augmentationOutputPathInput: document.getElementById(
    "augmentationOutputPathInput",
  ),
  augmentationOverwriteOutputField: document.getElementById(
    "augmentationOverwriteOutputField",
  ),
  augmentationOverwriteOutputInput: document.getElementById(
    "augmentationOverwriteOutputInput",
  ),
  ...
  augmentationProgressLabel: document.getElementById(
    "augmentationProgressLabel",
  ),
  augmentationProgressPercent: document.getElementById(
    "augmentationProgressPercent",
  ),
  augmentationProgressFill: document.getElementById("augmentationProgressFill"),
  augmentationProgressDetails: document.getElementById(
    "augmentationProgressDetails",
  ),
  ...
  duplicateDatasetPathInput: document.getElementById(
    "duplicateDatasetPathInput",
  ),
  duplicateTranscriptColumnInput: document.getElementById(
    "duplicateTranscriptColumnInput",
  ),
  duplicateNormalizeTextInput: document.getElementById(
    "duplicateNormalizeTextInput",
  ),
  ...
  duplicateOverwriteOutputField: document.getElementById(
    "duplicateOverwriteOutputField",
  ),
  duplicateOverwriteOutputInput: document.getElementById(
    "duplicateOverwriteOutputInput",
  ),
  runDuplicateCleanerButton: document.getElementById(
    "runDuplicateCleanerButton",
  ),
...
function joinUrl(...parts) {
  ...
  const prefix = /^https?:\/\//i.test(first)
    ? first.replace(/\/+$/, "")
    : first.replace(/\/+$/, "");
  const tail = cleaned
...
function switchPage(page) {
  ...
  if (els.hfHubPage) els.hfHubPage.hidden = page !== "hfHub";
  ...
  if (els.navHfHub)
    els.navHfHub.classList.toggle("is-active", page === "hfHub");
  els.navGenerator.classList.toggle("is-active", page === "generator");
  if (els.navCleaner)
    els.navCleaner.classList.toggle("is-active", page === "cleaner");
}
  ...
  try {
    ...
    for (const entry of entries) {
      addDataset({
        ...
        isFinal:
          Boolean(entry.final) ||
          isFinalDataset(entry.path || payload.path || ""),
      });
    }
    ...
    if (!silent)
      showMessage(
        "success",
        "Dataset loaded",
        `Loaded ${formatNumber(entries.length)} split(s) from ${payload.path}.`,
      );
    return true;
  } catch (error) {
...
async function detectServerFeatures() {
  try {
    ...
    state.hfDatasetToolsAvailable =
      features.includes("hf-dataset-merge") &&
      features.includes("hf-dataset-push");
    ...
    if (els.serverInfoText) {
      els.serverInfoText.textContent =
        "Backend ready. Dataset loading, Hugging Face tools, generation, and cleaning actions are available.";
    }
  } catch {
    ...
    if (els.serverInfoText) {
      els.serverInfoText.textContent =
        "Static mode. Use viewer_server.py to load server paths, use Hugging Face tools, generate audio, or clean datasets.";
    }
  }

  if (els.serverStatusDot)
    els.serverStatusDot.classList.toggle("is-online", state.serverAvailable);
...
async function loadDatasetFromForm(event) {
  ...
  if (!path) {
    showError(
      ...
      "Enter the dataset folder path before loading.",
    );
    return;
  }
...
async function startHfDatasetImport(event) {
  ...
  if (!params.repo_id || /\s/.test(params.repo_id)) {
    showError(
      "Invalid dataset repo",
      "Enter a Hugging Face dataset repo id like `owner/name`.",
    );
    return;
  }
  ...
  setHfImportProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing the Hugging Face import...",
  });
...
async function pollHfImportStatus() {
  ...
  try {
    const response = await fetch(
      `./api/hf/status?id=${encodeURIComponent(state.hfImportJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      if (loaded) {
        ...
        showError(
          "Imported but could not visualize",
          "The dataset was saved locally, but the viewer could not load it.",
          outputPath,
        );
      }
      ...
      els.importHfDatasetButton.textContent = "Import Dataset";
      showError(
        "Hugging Face import failed",
        payload.job.error || "The import job failed.",
...
async function runSyntheticTest() {
  ...
  const previousText =
    els.syntheticTestButton.textContent.trim() || "Run 1-Sample Test";
  ...
  try {
    ...
    if (!referenceAudio || !referenceText) {
      throw new Error(
        "Reference audio path and reference text are required for OmniVoice.",
      );
    }
    ...
    state.datasets = state.datasets.filter(
      (item) => item.source !== "synthetic-test",
    );
    addDataset({
    ...
    showMessage(
      "success",
      "1-sample test completed",
      "Generated one synthetic text and audio sample. It is loaded in the dataset viewer.",
    );
  } catch (error) {
    console.error(error);
...
function setGenerationProgress(status = {}) {
  ...
  els.generationProgressLabel.textContent =
    status.stage || status.status || "Generation";
  els.generationProgressDetails.textContent =
    status.message || "Waiting for job status...";
}
...
async function startGeneration(event) {
  ...
  if (
    !params.config_path ||
    !params.output_dir ||
    !params.reference_speakers_dir
  ) {
    showError(
      "Missing generator parameter",
      "Config path, output folder, and reference speaker folder are required.",
    );
    return;
  }
  if (params.num_texts < 1 || params.num_texts > 30000) {
    showError(
      "Invalid text count",
      "Number of texts must be between 1 and 30000.",
    );
    return;
  }
  ...
  setGenerationProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing the generation job...",
  });
...
async function pollGenerationStatus() {
  ...
  try {
    const response = await fetch(
      `./api/generation/status?id=${encodeURIComponent(state.generationJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      showMessage(
        ...
        payload.job.message || "Dataset generation finished.",
      );
    } else if (payload.job.status === "failed") {
      window.clearInterval(state.generationPollTimer);
      els.generateDatasetButton.disabled = false;
      ...
      showError(
        "Generation failed",
        payload.job.error || "The generation job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
function formatRowsBySplit(rowsBySplit = {}) {
  ...
  return entries
    .map(([split, rows]) => `${split}: ${formatNumber(rows)}`)
    .join(", ");
}
...
function renderHfColumnToggles(columns = []) {
  ...
  const selected = new Set(
    columnValuesFromText(els.hfPushColumnsInput?.value || ""),
  );
  ...
  for (const column of columns) {
    ...
    checkbox.addEventListener("change", () => {
      const checkedColumns = Array.from(
        els.hfColumnToggles.querySelectorAll("input:checked"),
      ).map((input) => input.value);
      if (!checkedColumns.length) {
        checkbox.checked = true;
        setColumnsInput([column]);
        showToast(
          "Keep at least one column selected, or clear the columns field to push all columns.",
        );
        return;
      }
  ...
  setColumnsInput(
    Array.from(selectedOrAll).filter((column) => columns.includes(column)),
  );
}
...
async function loadHfColumns({ silent = false } = {}) {
  ...
  if (!path) {
    if (!silent)
      showError(
        "Missing HF dataset path",
        "Enter the dataset path before loading columns.",
      );
    return false;
  }
  ...
  try {
    const response = await fetch(
      `./api/hf/columns?path=${encodeURIComponent(path)}`,
      { cache: "no-store" },
    );
    const payload = await response.json().catch(() => ({}));
    if (!response.ok || !payload.ok)
...
async function startHfDatasetMerge(event) {
  ...
  if (params.dataset_paths.length < 2) {
    showError(
      "Missing HF dataset paths",
      "Enter at least two `hf_dataset` folders, one per line.",
    );
    return;
  }
  if (!params.output_path) {
    showError(
      ...
      "Choose where the merged Hugging Face dataset should be saved.",
    );
    return;
  }
  ...
  setHfMergeProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing the merge job...",
  });
...
async function pollHfMergeStatus() {
  ...
  try {
    const response = await fetch(
      `./api/hf/status?id=${encodeURIComponent(state.hfMergeJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      const result = payload.job.result || {};
      const outputPath =
        result.output_path || els.hfMergeOutputInput.value.trim();
      state.mergedHfDatasetPath = outputPath;
      if (els.hfPushDatasetPathInput)
        els.hfPushDatasetPathInput.value = outputPath;
      if (els.pushHfDatasetButton)
        els.pushHfDatasetButton.disabled = !state.hfDatasetToolsAvailable;
      ...
      showMessage(
        ...
        "HF datasets merged",
        splitSummary
          ? `${payload.job.message}. Splits: ${splitSummary}.`
          : payload.job.message,
      );
    } else if (payload.job.status === "failed") {
      window.clearInterval(state.hfMergePollTimer);
      ...
      els.mergeHfDatasetsButton.textContent = "Merge HF Datasets";
      showError(
        "HF dataset merge failed",
        payload.job.error || "The merge job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
function hfPushParamsFromForm() {
  return {
    dataset_path:
      els.hfPushDatasetPathInput?.value.trim() || state.mergedHfDatasetPath,
...
async function startHfDatasetPush(event) {
  ...
  if (!params.dataset_path) {
    showError(
      "Missing HF dataset path",
      "Enter a Hugging Face `save_to_disk` folder path.",
    );
    return;
  }
  if (!params.repo_id || /\s/.test(params.repo_id)) {
    showError(
      "Invalid repo id",
      "Enter a Hugging Face dataset repo id like `username/darija-code-switch-asr`.",
    );
    return;
  }
  ...
  setHfPushProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing the Hugging Face push...",
  });
...
async function pollHfPushStatus() {
  ...
  try {
    const response = await fetch(
      `./api/hf/status?id=${encodeURIComponent(state.hfPushJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      showMessage(
        ...
        payload.job.message || "Dataset pushed.",
        result.repo_url || "",
      );
    } else if (payload.job.status === "failed") {
      window.clearInterval(state.hfPushPollTimer);
      ...
      showError(
        ...
        payload.job.error || "The push job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
function setCleanerSaveModeState() {
  ...
  if (els.cleanerOutputPathField)
    els.cleanerOutputPathField.hidden = isOverwrite;
  if (els.cleanerOverwriteOutputField)
    els.cleanerOverwriteOutputField.hidden = isOverwrite;
}

function setDuplicateSaveModeState() {
  const isOverwrite = els.duplicateSaveModeInput?.value === "overwrite";
  if (els.duplicateOutputPathField)
    els.duplicateOutputPathField.hidden = isOverwrite;
  if (els.duplicateOverwriteOutputField)
    els.duplicateOverwriteOutputField.hidden = isOverwrite;
}

function setTextNormalizerSaveModeState() {
  const isOverwrite = els.textNormalizerSaveModeInput?.value === "overwrite";
  if (els.textNormalizerOutputPathField)
    els.textNormalizerOutputPathField.hidden = isOverwrite;
  if (els.textNormalizerOverwriteOutputField)
    els.textNormalizerOverwriteOutputField.hidden = isOverwrite;
}

function setDurationFilterSaveModeState() {
  const isOverwrite = els.durationFilterSaveModeInput?.value === "overwrite";
  if (els.durationFilterOutputPathField)
    els.durationFilterOutputPathField.hidden = isOverwrite;
  if (els.durationFilterOverwriteOutputField)
    els.durationFilterOverwriteOutputField.hidden = isOverwrite;
}

function setAugmentationSaveModeState() {
  const isOverwrite = els.augmentationSaveModeInput?.value === "overwrite";
  if (els.augmentationOutputPathField)
    els.augmentationOutputPathField.hidden = isOverwrite;
  if (els.augmentationOverwriteOutputField)
    els.augmentationOverwriteOutputField.hidden = isOverwrite;
}
...
function textNormalizerParamsFromForm() {
  return {
    ...
    transcript_column:
      els.textNormalizerTranscriptColumnInput?.value.trim() || "",
    output_column:
      els.textNormalizerOutputColumnInput?.value.trim() || "normalized_text",
...
function augmentationParamsFromForm() {
  return {
    ...
    target_extra_percent: Number(
      els.augmentationTargetPercentInput?.value || 50,
    ),
    source_column: els.augmentationSourceColumnInput?.value.trim() || "source",
    include_source_terms:
      els.augmentationIncludeSourcesInput?.value.trim() || "",
    exclude_source_terms:
      els.augmentationExcludeSourcesInput?.value.trim() || "",
    speed_coverage_percent: Number(
      els.augmentationSpeedCoverageInput?.value || 0,
    ),
    noise_coverage_percent: Number(
      els.augmentationNoiseCoverageInput?.value || 0,
    ),
    reverb_coverage_percent: Number(
      els.augmentationReverbCoverageInput?.value || 0,
    ),
    telephony_coverage_percent: Number(
      els.augmentationTelephonyCoverageInput?.value || 0,
    ),
    gain_coverage_percent: Number(
      els.augmentationGainCoverageInput?.value || 0,
    ),
...
function formatSplitCounts(counts = {}) {
  ...
  if (!entries.length) return "";
  return entries
    .map(([split, count]) => `${split}: ${formatNumber(count)}`)
    .join(", ");
}
...
function renderCleanerResult(result = {}) {
  ...
  const preview = Array.isArray(result.bad_samples_preview)
    ? result.bad_samples_preview.slice(0, 8)
    : [];
  const previewLines = preview.map((sample) => {
    const row =
      sample.row !== undefined
        ? `row ${formatNumber(Number(sample.row) + 1)}`
        : "row ?";
    const split = sample.split || "split";
    const reason = sample.reason || "failed";
    const cer = sample.cer !== undefined ? `, CER ${sample.cer}` : "";
    const cps =
      sample.chars_per_second !== undefined
        ? `, ${sample.chars_per_second} chars/sec`
        : "";
...
function renderDurationFilterResult(result = {}) {
  ...
  const previewLines = preview.map((sample) => {
    ...
    const seconds =
      sample.duration_seconds !== undefined
...
function renderDuplicateResult(result = {}) {
  ...
  const previewLines = preview.map((sample) => {
    ...
    const firstRow =
      first.row !== undefined
        ? `row ${formatNumber(Number(first.row) + 1)}`
        : "row ?";
    const id = sample.id ? `, ${sample.id}` : "";
...
async function startDatasetCleaner(event) {
  ...
  if (!params.dataset_path) {
    showError(
      "Missing dataset path",
      "Enter the Hugging Face dataset folder path before cleaning.",
    );
    return;
  }
  if (!params.use_whisper && !params.use_cps && !params.remove_sources) {
    showError(
      "No cleaner checks selected",
      "Enable Whisper CER, chars/sec, or specify sources to remove.",
    );
    return;
  }
  if (params.min_cps > params.max_cps) {
    showError(
      "Invalid chars/sec range",
      "Min chars/sec must be less than or equal to max chars/sec.",
    );
    return;
  }
  if (params.output_mode === "copy" && !params.output_path) {
    showError(
      "Missing output path",
      "Enter a destination for the cleaned dataset copy.",
    );
    return;
  }
  ...
  setCleanerProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing the bad-sample removal job...",
  });
...
async function pollDatasetCleanerStatus() {
  ...
  try {
    const response = await fetch(
      `./api/cleaner/status?id=${encodeURIComponent(state.cleanerJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      els.runCleanerButton.textContent = "Run Cleaner";
      showError(
        "Dataset cleaner failed",
        payload.job.error || "The cleaner job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
async function startTextNormalizer(event) {
  ...
  if (!params.dataset_path) {
    showError(
      "Missing dataset path",
      "Enter the Hugging Face dataset folder path before normalizing.",
    );
    return;
  }
  if (!params.overwrite_text && !params.output_column) {
    showError(
      ...
      "Enter a column name such as normalized_text.",
    );
    return;
  }
  if (params.output_mode === "copy" && !params.output_path) {
    showError(
      "Missing output path",
      "Enter a destination for the normalized dataset copy.",
    );
    return;
  }
  if (params.output_mode === "overwrite") {
  ...
  setTextNormalizerProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing transcript normalization...",
  });
  ...
  try {
    ...
    state.textNormalizerPollTimer = window.setInterval(
      pollTextNormalizerStatus,
      1500,
    );
  } catch (error) {
...
async function pollTextNormalizerStatus() {
  ...
  try {
    const response = await fetch(
      `./api/cleaner/status?id=${encodeURIComponent(state.textNormalizerJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      showError(
        ...
        payload.job.error || "The text normalizer job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
async function startDurationFilter(event) {
  ...
  if (!params.dataset_path) {
    showError(
      "Missing dataset path",
      "Enter the Hugging Face dataset folder path before filtering durations.",
    );
    return;
  }
  if (
    !Number.isFinite(params.min_seconds) ||
    !Number.isFinite(params.max_seconds)
  ) {
  ...
  if (
    ...
    params.max_seconds <= 0 ||
    params.min_seconds > params.max_seconds
  ) {
    showError(
  ...
  if (params.output_mode === "copy" && !params.output_path) {
    showError(
      "Missing output path",
      "Enter a destination for the duration-filtered dataset copy.",
    );
    return;
  }
  if (params.output_mode === "overwrite") {
  ...
  setDurationFilterProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing duration filtering...",
  });
  ...
  try {
    ...
    state.durationFilterPollTimer = window.setInterval(
      pollDurationFilterStatus,
      1500,
    );
  } catch (error) {
...
async function pollDurationFilterStatus() {
  ...
  try {
    const response = await fetch(
      `./api/cleaner/status?id=${encodeURIComponent(state.durationFilterJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      showError(
        ...
        payload.job.error || "The duration filter job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
async function startDataAugmentation(event) {
  ...
  if (!params.dataset_path) {
    showError(
      "Missing dataset path",
      "Enter the Hugging Face dataset folder path before augmentation.",
    );
    return;
  }
  if (
    !Number.isFinite(params.target_extra_percent) ||
    params.target_extra_percent <= 0
  ) {
    showError(
      "Invalid target extra %",
      "Enter a target extra percentage greater than 0.",
    );
    return;
  }
  if (
    coverages.some((value) => !Number.isFinite(value) || value < 0) ||
    !coverages.some((value) => value > 0)
  ) {
    showError(
      "Invalid augmentation coverage",
      "Enable at least one non-negative augmentation coverage value.",
    );
    return;
  }
  if (
    ...
    showError(
      "Invalid max copies",
      "Max copies per original must be a whole number from 1 to 5.",
    );
    return;
  }
  if (params.output_mode === "copy" && !params.output_path) {
    showError(
      "Missing output path",
      "Enter a destination for the augmented dataset copy.",
    );
    return;
  }
  if (params.output_mode === "overwrite") {
  ...
  setAugmentationProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing data augmentation...",
  });
  ...
  try {
    ...
    state.augmentationPollTimer = window.setInterval(
      pollDataAugmentationStatus,
      1500,
    );
  } catch (error) {
...
async function pollDataAugmentationStatus() {
  ...
  try {
    const response = await fetch(
      `./api/cleaner/status?id=${encodeURIComponent(state.augmentationJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      showError(
        ...
        payload.job.error || "The data augmentation job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
async function startDuplicateCleaner(event) {
  ...
  if (!params.dataset_path) {
    showError(
      "Missing dataset path",
      "Enter the Hugging Face dataset folder path before deduplicating.",
    );
    return;
  }
  if (params.output_mode === "copy" && !params.output_path) {
    showError(
      "Missing output path",
      "Enter a destination for the deduplicated dataset copy.",
    );
    return;
  }
  if (params.output_mode === "overwrite") {
  ...
  setDuplicateProgress({
    percent: 1,
    stage: "Starting",
    message: "Preparing duplicate text removal...",
  });
  ...
  try {
    ...
    state.duplicateCleanerPollTimer = window.setInterval(
      pollDuplicateCleanerStatus,
      1500,
    );
  } catch (error) {
...
async function pollDuplicateCleanerStatus() {
  ...
  try {
    const response = await fetch(
      `./api/cleaner/status?id=${encodeURIComponent(state.duplicateCleanerJobId)}`,
      {
        cache: "no-store",
      },
    );
    ...
    if (payload.job.status === "completed") {
      ...
      els.runDuplicateCleanerButton.textContent = "Remove Duplicates";
      showError(
        "Duplicate cleaner failed",
        payload.job.error || "The duplicate cleaner job failed.",
        payload.job.log_tail || "",
      );
    }
  } catch (error) {
...
function audioLookupKeys(pathLike) {
  ...
  const audioIndex = normalized.search(
    /(^|\/)(audio|audios|clips|recordings|wavs)(\/|$)/i,
  );
  if (audioIndex >= 0) {
...
async function handleFiles(fileList) {
  ...
  const audioFiles = files.filter((file) =>
    AUDIO_EXTENSIONS.has(getExtension(getFilePath(file))),
  );
  const dataFiles = files.filter((file) =>
    DATA_EXTENSIONS.has(getExtension(getFilePath(file))),
  );
...
function readableName(path) {
  const file = basename(path).replace(
    /\.(csv|tsv|json|jsonl|ndjson|txt)$/i,
    "",
  );
  return file
    .replace(/[_-]+/g, " ")
  ...
  if (parsed && typeof parsed === "object") {
    ...
    for (const key of preferredKeys) {
      if (Array.isArray(parsed[key])) {
        return [
          { name: readableName(path), records: parsed[key].map(toRecord) },
        ];
      }
    }
...
function toRecord(value, index = 0) {
  ...
  if (Array.isArray(value)) {
    return Object.fromEntries(
      value.map((item, itemIndex) => [`value_${itemIndex + 1}`, item]),
    );
  }
...
function addDataset(dataset) {
  const preparedRecords = dataset.records.map((record, index) =>
    toRecord(record, index),
  );
...
function chooseDefaultDataset() {
  ...
  const currentExists = state.datasets.some(
    (dataset) => dataset.id === state.activeId,
  );
...
function activeDataset() {
  return (
    state.datasets.find((dataset) => dataset.id === state.activeId) || null
  );
}
...
function findAudioPath(row, dataset) {
  const serverPlayerColumn = Object.keys(row).find(
    (column) => column.startsWith("_play_") && row[column],
  );
  if (serverPlayerColumn) {
    return {
      path: String(row[serverPlayerColumn]),
      column: serverPlayerColumn,
    };
  }
  ...
  const preferred = dataset.columns
    .filter(
      (column) =>
        AUDIO_NAME_RE.test(column) ||
        AUDIO_PATH_RE.test(String(row[column] || "")),
    )
    .concat(
      dataset.columns.filter((column) => /audio\.path|path$/i.test(column)),
    );
  ...
  for (const column of preferred) {
    ...
    const columnStronglyAudio =
      /(audio|sound|recording|voice|clip|wav|mp3|flac|m4a|ogg)/i.test(column);
    if (
...
function resolveAudio(row, dataset) {
  ...
  if (!candidate.path)
    return { path: "", column: "", src: "", sources: [], matched: false };
...
function findLocalAudio(path, dataset) {
  ...
  if (dataset.baseDir) {
    for (const key of audioLookupKeys(joinUrl(dataset.baseDir, path)))
      candidates.add(key);
  }
...
function categoricalColumns(dataset) {
  ...
  return dataset.columns.filter((column) => {
    if (
      LONG_TEXT_RE.test(column) &&
      !/language|mix|source|domain|split/i.test(column)
    )
      return false;
...
function renderStats(dataset, filteredCount) {
  ...
  const totalSeconds = durationColumn
    ? sumDurationSeconds(dataset.records, durationColumn)
    : 0;
  const filteredRows =
    filteredCount === dataset.records.length
      ? dataset.records
      : getFilteredRows(dataset, { includeSort: false });
  const filteredSeconds = durationColumn
    ? sumDurationSeconds(filteredRows, durationColumn)
    : 0;
  ...
  stats.push({
    label: diskRows > dataset.records.length ? "Rows Loaded" : "Rows",
    value: formatNumber(dataset.records.length),
  });
  if (diskRows > dataset.records.length)
    stats.push({ label: "Rows In Split", value: formatNumber(diskRows) });
  ...
  stats.push({
    ...
    value: formatNumber(dataset.audioLinked),
  });
  if (dataset.audioCandidates)
    stats.push({ label: "Missing Audio", value: formatNumber(missing) });
  if (durationColumn) {
    stats.push({ label: "Total Hours", value: formatHours(totalSeconds) });
    if (filteredCount !== dataset.records.length)
      stats.push({
        label: "Visible Hours",
        value: formatHours(filteredSeconds),
      });
    if (dataset.records.length)
      stats.push({
        label: "Avg Duration",
        value: formatDuration(totalSeconds / dataset.records.length),
      });
  }
...
function renderDistributionChart(dataset, filteredRows) {
  ...
  const ranked = buckets
    ...
    .sort(
      (a, b) => b.metricValue - a.metricValue || a.label.localeCompare(b.label),
    )
    .slice(0, 20);
...
function activeColumnFilters(dataset) {
  return Array.from(state.exactFilters.entries()).filter(
    ([column, filter]) =>
      dataset.columns.includes(column) && filter.values.size,
  );
}

function getColumnFilter(column) {
  return (
    state.exactFilters.get(column) || {
      mode: state.facetMode,
      values: new Set(),
    }
  );
}
...
function valueBuckets(rows, column, mode, durationColumn = "") {
  ...
  for (const row of rows) {
    ...
    const duration = durationColumn
      ? durationSeconds(row[durationColumn], durationColumn)
      : 0;
...
function facetKeysForValue(value, mode) {
  if (mode === "token") {
    const tokens = splitFacetTokens(value)
      .map(facetKeyForScalar)
      .filter(Boolean);
...
function facetKeyForValue(value, mode = "exact") {
  if (mode === "token")
    return facetKeysForValue(value, mode)[0] || EMPTY_FACET_KEY;
  if (value === undefined || value === null || value === "")
    return EMPTY_FACET_KEY;
  if (Array.isArray(value)) {
    const parts = value
      .map(valueToString)
      .map((item) => item.trim())
...
function findDurationColumn(dataset) {
  const exact = dataset.columns.find((column) =>
    /^duration_seconds$/i.test(column),
  );
  if (exact) return exact;

  const named = dataset.columns.find(
    (column) =>
      DURATION_NAME_RE.test(column) &&
      columnHasNumericDuration(dataset, column),
  );
  ...
  return (
    dataset.columns.find(
      (column) =>
        columnHasNumericDuration(dataset, column) &&
        /duration|seconds|length/i.test(column),
    ) || ""
  );
}
...
function sumDurationSeconds(rows, column) {
  return rows.reduce(
    (sum, row) => sum + durationSeconds(row[column], column),
    0,
  );
}
...
function durationUnitSeconds(value, column = "") {
  const lower = column.toLowerCase();
  if (/(^|[._-])(ms|millis|milliseconds)([._-]|$)/.test(lower))
    return value / 1000;
...
function renderColumnControls(dataset) {
  ...
  els.columnFocus.value = dataset.columns.includes(currentFocus)
    ? currentFocus
    : state.focusedColumn;
...
function getFilteredRows(dataset, options = {}) {
  ...
  let rows = dataset.records.filter((row) => {
    ...
    if (
      state.audioFilter === "missing" &&
      (!row.__audioInfo?.path || row.__audioInfo?.src)
    ) {
      return false;
    }
    ...
    return columns.some((column) =>
      valueToString(row[column]).toLowerCase().includes(query),
    );
  });
  ...
  if (includeSort && state.sort.column) {
    ...
    rows = [...rows].sort(
      (a, b) =>
        compareValues(a[state.sort.column], b[state.sort.column]) * direction,
    );
  }
...
async function loadManifest({ silent = false } = {}) {
  ...
  try {
    const response = await fetch("./viewer-manifest.json", {
      cache: "no-store",
    });
    if (!response.ok) throw new Error(`HTTP ${response.status}`);
    const manifest = await response.json();
    state.datasets = state.datasets.filter(
      (dataset) => dataset.source !== "manifest",
    );
    state.activeId = null;
    ...
    if (!silent)
      showError(
        "No manifest found",
        "Create viewer-manifest.json or use the dataset path loader.",
      );
  } finally {
  ...
  for (const entry of entries) {
    ...
    for (const item of parsed) {
      addDataset({
        ...
        records: item.records,
        isFinal:
          Boolean(entry.final) || item.isFinal || isFinalDataset(entry.path),
      });
      loaded += 1;
    }
  }
...
function bindEvents() {
  ...
  on(els.navHfHub, "click", () => switchPage("hfHub"));
  ...
  on(els.hideLongColumns, "click", () => {
    ...
    dataset.visibleColumns = new Set(
      dataset.columns.filter(
        (column) =>
          !LONG_TEXT_RE.test(column) ||
          /text|sentence|transcript/i.test(column),
      ),
    );
    render();
  });
